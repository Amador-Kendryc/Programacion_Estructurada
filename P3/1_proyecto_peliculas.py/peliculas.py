...
def modificarPeliculas():
    ...
    if conexionBD!=None:
      ...
      if registros:
        ...
        if resp=="si":
           #pelicula["nombre"]=input("Dame el nuevo nombre de la pelicula a modificar: ").upper().strip()
           nuevonombre=input("Dame el nuevo nombre de la pelicula a modificar: ").upper().strip()
           nuevacategoria=input("Dame la nueva categoria de la pelicula a modificar: ").upper().strip()
           nuevaclas=input("Dame la nueva clasificacion de la pelicula a modificar: ").upper().strip()
           nuevogenero=input("Dame el nuevo genero de la pelicula a modificar: ").upper().strip()
           nuevoidioma=input("Dame el nuevo idioma de la pelicula a modificar: ").upper().strip()
           sql="update peliculas set nombre = %s, categoria = %s, clasificacion = %s, genero = %s, idioma = %s"
           val=(nuevonombre,nuevacategoria,nuevaclas,nuevogenero,nuevoidioma)
           cursor.execute(sql,val)
           conexionBD.commit()
           print("\n\t\t :::¡LA OPERACION SE REALIZÓ CON EXÍTO! :::")
      else:
