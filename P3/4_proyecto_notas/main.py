...
def menu_notas(usuario_id,nombre,apellidos):
    while True:
        ...
        if opcion == '1' or opcion=="CREAR":
            ...
            if respuesta:
                print(f"\n\tSe creo la nota {titulo} con excito")
            else:
            ...
            #Agregar codigo
                    ...
                    if respuesta:
                        print(f"\n\tSe actualizó la nota {titulo} con excito")
                    else:
                        print(f"\n\t..No fue posible crear la nota, intenta mas tarde") 
                funciones.esperarTecla()      
            ...
            #Agregar codigo
                         ...
                         if respuesta:
                            ...
                            print(f"\n\t..No fue posible borrar la nota, intenta mas tarde")
                funciones.esperarTecla()   
            ...
            if len(lista_notas)>0:
                ...
                resp=input("Deseas buscar alguna nota si/no ").lower().strip()
                if resp=="si":
            ...
            #Agregar codigo
                    ...
                    if respuesta:
                        ...
                        print(f"-"*80)
                        #for fila in lista_notas:
                        print(f"{respuesta[0]:<10}{respuesta[2]:<10}{respuesta[3]:<10}{fila[4]:<10}")
                        print(f"-"*80)
                        print(f"\n\tSe buscó la nota {id} con exito")
                    else:
                        print(f"\n\t..No fue posible buscar la nota, intenta mas tarde") 
                funciones.esperarTecla()     
